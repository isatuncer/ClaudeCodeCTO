...
> Convierte Claude Code en un CTO de ciclo de vida completo: 2.388 skills, agents y commands seleccionados a mano de 15 repositorios open-source líderes, instalados en `~/.claude/` con cero costo externo.
...
CloaudeCodeCTO es un **sistema de curación e instalación** que toma los mejores skills, agents y commands de 15 repositorios públicos de Claude Code y los instala en tu directorio `~/.claude/` como un kit de herramientas unificado.
...
- **2.388 componentes** — 1.845 skills + 307 agents + 236 commands, curados de 15 repos
...
15 submódulos activos. Todas las licencias se preservan en sus respectivos directorios.
...
Este proyecto cura contenido de 15 repositorios open-source. Ver [`.gitmodules`](../../.gitmodules) para la lista completa. Todas las licencias de submódulos se preservan en sus directorios `sources/<repo>/`.
