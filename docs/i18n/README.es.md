...
> Convierte Claude Code en un CTO de ciclo de vida completo: 3.025 skills, agents y commands seleccionados a mano de 17 repositorios open-source líderes, instalados en `~/.claude/` con cero costo externo.
...
- **3.025 componentes** — 2.044 skills + 550 agents + 431 commands, curados de 17 repos
...
├── agents/                        550 agents especializados
...
17 submódulos activos. Todas las licencias se preservan en sus respectivos directorios.
...
**P: ¿Cuál es el costo en tokens de cargar 2.044 skills?**
...
Este proyecto cura contenido de 17 repositorios open-source. Ver [`.gitmodules`](../../.gitmodules) para la lista completa. Todas las licencias de submódulos se preservan en sus directorios `sources/<repo>/`.
