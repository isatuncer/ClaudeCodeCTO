#!/usr/bin/env bash
# ============================================================
# ClaudeCodeCTO Installer — Stage 5
#
...
echo ""
echo -e "${CYAN}==========================================${NC}"
echo -e "${BOLD}  ClaudeCodeCTO Installer${NC}"
echo -e "${CYAN}==========================================${NC}"
echo ""
...
This Claude Code installation was curated by ClaudeCodeCTO.
...
# the hook config into settings.json. After install, ClaudeCodeCTO hooks
...
settings["$comment"] = "Generated by ClaudeCodeCTO installer. Hooks merged from EEC runtime."
