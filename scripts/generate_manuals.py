#!/usr/bin/env python3
"""
CloaudeCodeCTO Manual Generator
...
def generate_manual(ctype: str, components: list, when: str) -> str:
    ...
    lines.append("")
    lines.append(f"> Snapshot of all {plural.lower()} in the CloaudeCodeCTO catalog on **{when}**.")
    lines.append("")
...
def update_index(out_dir: Path) -> None:
    ...
    lines = []
    lines.append("# 📚 CloaudeCodeCTO Manuals Index")
    lines.append("")
